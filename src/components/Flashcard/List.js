...
const List = (props) => {
    ...
    const cards = props.cards.map((card) =>
        <tr key={card.id}>
            ...
            <td>
                <Link to={`${url}/edit/${card.id}`}><Button color="secondary">Edit</Button></Link>
            </td>
            <td>
                <Button color="danger" data-card={card.id} onClick={props.onDeleteClick}>Delete</Button>
            </td>
        </tr>
    );
        ...
        <Container>
            <Row>
                <Col>
                    ...
                    <div>
                        <Button color="primary" tag={Link} to={`${url}/create`}>Create new card</Button>
                    </div>
                </Col>
            </Row>
            <Modal isOpen={props.modal} toggle={props.toggle} backdrop={false}>
                ...
                <ModalFooter>
                    <Button color="danger" onClick={props.onDeleteConfirmationClick}>Delete card</Button>{' '}
